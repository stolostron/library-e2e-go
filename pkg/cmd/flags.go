...
func InitFlags(flagset *flag.FlagSet) {
	...
	flagset.StringVar(&End2End.KubeadminUser, "kubeadmin-user", "kubeadmin",
		"Provide the kubeadmin credential for the cluster under test (e.g. -kubeadmin-user=\"xxxxx\").")
	flagset.StringVar(&End2End.KubeadminCredential, "kubeadmin-credential", "",
		"Provide the kubeadmin credential for the cluster under test"+
			" (e.g. -kubeadmin-credential=\"xxxxx-xxxxx-xxxxx-xxxxx\").")
